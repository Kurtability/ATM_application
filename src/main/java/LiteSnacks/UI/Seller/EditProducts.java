...
public class EditProducts {
    ...
    public EditProducts(double width, double height, Stage stage){
        ...
        List<Item> items = new ArrayList<>(Arrays.asList(new Item(10, 1.0, "coca", "CHIPS", "0011"), new Item(20, 1.0, "AH", "CHIPS", "002"), new Item(0, 1.0, "pesi", "CHIPS", "003"), new Item(1, 1.0, "pesi", "CHIPS", "003")));
